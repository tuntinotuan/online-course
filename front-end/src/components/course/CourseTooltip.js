...
const CourseTooltip = ({
  ...
  return ReactDOM.createPortal(
    <div
      className={`absolute top-0 w-[340px] h-auto bg-white dark:bg-darkMain dark:text-white border border-gray-300 dark:border-primaryBlack p-6 transition-all duration-200 ${
        hovered
