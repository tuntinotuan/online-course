  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className={`w-full border border-primaryBlack placeholder:text-primaryBlack placeholder:text-opacity-75 focus:border focus:border-purpleTextA4 ${className}`}
